package com.zydcc.arcgis.core.util;
 ...
 * 谷歌地图采用的是WGS84坐标系（中国范围除外）
 * GCJ02坐标系：火星坐标系，是由中国国家测绘局制定的地理信息系统的坐标系统。由WGS84坐标系经加密后的坐标系
 * 谷歌中国地图和搜搜中国地球采用的是GCJ02地理坐标系；BD09坐标系：即百度坐标系，GCJ02坐标系加密后的坐标系
 * 搜狗坐标系，图吧坐标系等，估计也是在GCJ02基础上加密而成的
 * Create by ningsikai 2020/6/2:9:49 AM
 * ========================================
 */
