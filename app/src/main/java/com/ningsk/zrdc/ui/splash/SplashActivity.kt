package com.ningsk.zrdc.ui.splash
...
import com.ningsk.zrdc.ui.main.MainActivity
...
class SplashActivity : AppCompatActivity(), EasyPermissions.PermissionCallbacks {
    ...
    private fun requirePermission() {
        ...
        EasyPermissions.requestPermissions(this, "一张图需要申请以下权限",
    ...
    private fun initData() {
        ...
        GlobalScope.launch {
            ...
            if (sharedPreferences.getBoolean("firststart", true)) {
                ...
                val lastProjectId = dataBase.projectDao().insert(project)
