 ...
 * ========================================
 */
public class GaodeTiledParam extends BaseTiledParam{
    ...
    public GaodeTiledParam(GisMapConfig gisMapConfig) {
        super(gisMapConfig);
    }
    ...
    public String getUrl(int level, int col, int row, BaseTiledType tiledType) {
        ...
        switch (tiledType) {
            ...
            case IMG_C:
                url = url.append("http://wprd0")
                        .append(subdomain + 1)
                        .append(".is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=6&x=")
                        .append(col)
                        .append("&y=")
                        .append(row)
                        .append("&z=")
            ...
            case CIA_C:
                url = url.append("http://wprd0")
                        .append(subdomain + 1)
                        .append(".is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x=")
                        .append(col)
                        .append("&y=")
                        .append(row)
                        .append("&z=")
