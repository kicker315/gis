...
import com.zydcc.arcgis.utils.func.Func1;
 ...
 * =======================================
 * 字符串工具类
 * Create by ningsikai 2020/6/3:8:57 AM
 * ========================================
 */
public class StringUtil {
     ...
     * @since 4.0.1
     */
    public static StringBuilderUtil strBuilder() {
        return StringBuilderUtil.create();
    }
     ...
     * @since 4.0.1
     */
    public static StringBuilderUtil strBuilder(int capacity) {
        return StringBuilderUtil.create(capacity);
    }
     ...
     * @return StrBuilder对象
     */
    public static StringBuilderUtil strBuilder(CharSequence... strs) {
        return StringBuilderUtil.create(strs);
    }
    ...
    public static String replace(CharSequence str, int fromIndex, CharSequence searchStr, CharSequence replacement, boolean ignoreCase) {
        ...
        final StringBuilderUtil result = StringBuilderUtil.create(strLength + 16);
        if (0 != fromIndex) {
     ...
     * @return 替换后的字符串
     *
     * @see RegexUtil#replaceAll(CharSequence, Pattern, Func1)
     * @since 4.2.2
     */
    ...
    public static String move(CharSequence str, int startInclude, int endExclude, int moveLength) {
        ...
        final StringBuilderUtil strBuilder = StringBuilderUtil.create(len);
        if (moveLength > 0) {
    ...
    public static String concat(boolean isNullToEmpty, CharSequence... strs) {
        final StringBuilderUtil sb = new StringBuilderUtil();
        for (CharSequence str : strs) {
