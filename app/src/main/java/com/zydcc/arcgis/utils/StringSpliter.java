 ...
 * =======================================
 * 字符串切割器
 * Create by ningsikai 2020/6/4:5:04 PM
 * ========================================
 */
public class StringSpliter {
    ...
    public static List<String> split(String str, char separator, int limit, boolean isTrim, boolean ignoreEmpty, boolean ignoreCase) {
        ...
        for (int i = 0; i < len; i++) {
            if (equalsChar(separator, str.charAt(i), ignoreCase)) {
     ...
     * @since 4.0.3
     */
    public static boolean equalsChar(char c1, char c2, boolean ignoreCase) {
        if (ignoreCase) {
    ...
    public static List<String> splitByRegex(String str, String separatorRegex, int limit, boolean isTrim, boolean ignoreEmpty) {
        final Pattern pattern = RegexUtil.get(separatorRegex);
