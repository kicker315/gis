 ...
 * @since 4.0.0
 */
public class StringBuilderUtil implements CharSequence, Appendable, Serializable {
     ...
     * 创建字符串构建器
     *
     * @return {@link StringBuilderUtil}
     */
    public static StringBuilderUtil create() {
     ...
     * @return {@link StringBuilderUtil}
     */
    public static StringBuilderUtil create(int initialCapacity) {
        return new StringBuilderUtil(initialCapacity);
    }
     ...
     * @since 4.0.1
     */
    public static StringBuilderUtil create(CharSequence... strs) {
        return new StringBuilderUtil(strs);
    }
     ...
     * @param initialCapacity 初始容量
     */
    public StringBuilderUtil(int initialCapacity) {
     ...
     * @since 4.0.1
     */
    public StringBuilderUtil(CharSequence... strs) {
     ...
     * @return this
     */
    public StringBuilderUtil append(char[] src) {
     ...
     * @return this
     */
    public StringBuilderUtil append(char[] src, int srcPos, int length) {
        return insert(this.position, src, srcPos, length);
    }

    @Override
    public StringBuilderUtil append(CharSequence csq) {
        return insert(this.position, csq);
    }

    @Override
    public StringBuilderUtil append(CharSequence csq, int start, int end) {
     ...
     * @return this
     */
    public StringBuilderUtil insert(int index, char c) {
     ...
     * @return this
     */
    public StringBuilderUtil insert(int index, char[] src) {
        if (ArrayUtil.isEmpty(src)) {
            return this;
        }
     ...
     * @return this
     */
    public StringBuilderUtil insert(int index, char[] src, int srcPos, int length) {
     ...
     * @return this
     */
    public StringBuilderUtil insert(int index, CharSequence csq) {
        if (null == csq) {
            csq = "null";
        }
        int len = csq.length();
        ...
        } else if (csq instanceof StringBuilderUtil) {
            ((StringBuilderUtil) csq).getChars(0, len, this.value, index);
        } else {
     ...
     * @return this
     */
    public StringBuilderUtil insert(int index, CharSequence csq, int start, int end) {
        if (csq == null) {
            csq = "null";
        }
     ...
     * @return this
     */
    public StringBuilderUtil getChars(int srcBegin, int srcEnd, char[] dst, int dstBegin) {
        if (srcBegin < 0) {
            srcBegin = 0;
        }
        if (srcEnd < 0) {
     ...
     * @return this
     */
    public StringBuilderUtil clear() {
        return reset();
    }
     ...
     * @return this
     */
    public StringBuilderUtil reset() {
        this.position = 0;
        return this;
    }
     ...
     * @return this
     */
    public StringBuilderUtil delTo(int newPosition) {
        if (newPosition < 0) {
            newPosition = 0;
        }
     ...
     */
    public StringBuilderUtil del(int start, int end) throws StringIndexOutOfBoundsException {
        if (start < 0) {
            start = 0;
        }
