...
import com.zydcc.arcgis.core.tiledservice.GaodeTiledParam;
...
public class GisMapConfig {
     ...
     * 底图缓存路径
     */
    private String baseMapCachePath = App.Companion.getAPP_CONTEXT().getExternalCacheDir() + "/map_tileCache/";
